//************************************************************************************
//**  
//**  Source name:   U:\Documents\SIN\Projet_SIN\Test_tactile_v1.fcfx
//**  Title:         
//**  Description:   
//**  Device:        PIC.18F.18F4520
//**  
//**  Generated by:  Flowcode v6.1.1.0
//**  Date:          Tuesday, January 10, 2017 17:43:39
//**  Users:         50
...
#define FCV_FALSE (0)
#define FCV_TRUE (1)
MX_GLOBAL MX_UINT16 FCV_POSITIONZ = (0x0);
...
void FCM_Appui_tactile()
{
	...
	while (1)
	{
		...
		// Boucle
		// Boucle: While PositionZ = 0
		while (FCV_POSITIONZ == 0)
		{

			// Appel de la Routine Composant
			// Appel de la Routine Composant: PositionZ=gLCD_EB076_4D1::G4D_GetTouchCoordinatesPicaso()
			FCV_POSITIONZ = FCD_0f051_gLCD_EB076_4D1__G4D_GetTouchCoordinatesPicaso();
