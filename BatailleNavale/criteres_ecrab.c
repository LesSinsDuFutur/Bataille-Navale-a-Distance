//************************************************************************************
//**  
//**  Source name:   U:\Documents\SIN\BatailleNavale\criteres_ecrab.fcfx
//**  Title:         
//**  Description:   
//**  Device:        PIC.18F.18F4520
//**  
//**  Generated by:  Flowcode v6.1.1.0
//**  Date:          Tuesday, March 28, 2017 17:07:43
//**  Users:         50
...
adcon1 = 0x0F;
	...
	while (1)
	{
		...
		// Sortie
		// Sortie: 255 -> PORTA
		FCP_SET(F, A, 0xFF, 0, (255));
		// Sortie
		// Sortie: 0 -> PORTA
		FCP_SET(F, A, 0xFF, 0, (0));
		// Appel de la Routine Composant
		// Appel de la Routine Composant: gLCD_EB076_4D1::ClearDisplay()
		FCD_0f051_gLCD_EB076_4D1__ClearDisplay();

		// Appel de la Routine Composant
		// Appel de la Routine Composant: gLCD_EB076_4D1::PrintNumber(a, 150, 200, 0, 2)
		FCD_0f051_gLCD_EB076_4D1__PrintNumber(FCV_A, 150, 200, 0, 2);
