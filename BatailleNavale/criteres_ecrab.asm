...
gbl_FCV_A                        EQU	0x0000002C ; bytes:1
...
FC_CAL_UAR_0005F_arg_new_baud    EQU	0x0000003A ; bytes:1
FC_CAL_UAR_0005F_1_baudrate      EQU	0x0000003B ; bytes:1
FC_CAL_UAR_0005F_1_baudmode      EQU	0x0000003C ; bytes:1
FC_CAL_UAR_00061_arg_nTimeout    EQU	0x00000050 ; bytes:1
CompTempVarRet2643               EQU	0x00000059 ; bytes:2
FC_CAL_UAR_00061_1_retVal        EQU	0x00000051 ; bytes:1
FC_CAL_UAR_00061_1_delay1        EQU	0x00000052 ; bytes:1
FC_CAL_UAR_00061_1_regcheck      EQU	0x00000053 ; bytes:1
FC_CAL_UAR_00061_1_bWaitForever  EQU	0x00000054 ; bytes:1
FC_CAL_UAR_00061_1_rxStatus      EQU	0x00000055 ; bytes:1
FC_CAL_UAR_00061_1_delaycnt      EQU	0x00000056 ; bytes:2
FC_CAL_UAR_00061_1_dummy         EQU	0x00000058 ; bytes:1
CompTempVar2644                  EQU	0x00000059 ; bytes:1
CompTempVar2645                  EQU	0x00000059 ; bytes:1
CompTempVar2646                  EQU	0x00000059 ; bytes:1
FC_CAL_UAR_00062_arg_nChar       EQU	0x00000050 ; bytes:2
CompTempVar2647                  EQU	0x00000052 ; bytes:1
FCD_0f051__0007E_arg_FCL_NUMBER  EQU	0x00000036 ; bytes:2
FCD_0f051__0007E_arg_FCL_X       EQU	0x00000038 ; bytes:2
FCD_0f051__0007E_arg_FCL_Y       EQU	0x0000003A ; bytes:2
FCD_0f051__0007E_arg_FCL_FONT    EQU	0x0000003C ; bytes:1
FCD_0f051__0007E_arg_FCL_T_0007F EQU	0x0000003D ; bytes:1
FCD_0f051__0007E_1_FCL_TEMP      EQU	0x0000003E ; bytes:6
FCD_0f051__00080_arg_FCL_STR     EQU	0x00000044 ; bytes:2
FCD_0f051__00080_arg_FCLsz_STR   EQU	0x00000046 ; bytes:2
FCD_0f051__00080_arg_FCL_X1      EQU	0x00000048 ; bytes:2
FCD_0f051__00080_arg_FCL_Y1      EQU	0x0000004A ; bytes:2
FCD_0f051__00080_arg_FCL_FONT    EQU	0x0000004C ; bytes:1
FCD_0f051__00080_arg_FCL_T_00081 EQU	0x0000004D ; bytes:1
FCD_0f051__00080_1_FCL_LEN_STR   EQU	0x0000004E ; bytes:1
FCD_0f051__00080_1_FCL_IDX       EQU	0x0000004F ; bytes:1
FCD_0f051__00093_1_FCL_Y         EQU	0x0000003A ; bytes:2
FCD_0f051__00093_1_FCL_X         EQU	0x0000003C ; bytes:2
FCD_0f051__0009E_1_FCL_RED       EQU	0x00000036 ; bytes:1
FCD_0f051__0009E_1_FCL_GREEN     EQU	0x00000037 ; bytes:1
FCD_0f051__0009E_1_FCL_BLUE      EQU	0x00000038 ; bytes:1
FCD_0f051__0009E_1_FCL_DUMMY     EQU	0x00000039 ; bytes:1
FCD_0f051__0009E_2_ptmp          EQU	0x0000003A ; bytes:1
...
main_6_ptmp                      EQU	0x00000036 ; bytes:1
main_12_ptmp                     EQU	0x00000036 ; bytes:1
...
; { FCD_0f051_gLCD_EB076_4D1__Print ; function begin
	CLRF FCD_0f051__00080_1_FCL_IDX
	MOVLW 0x4F
	MOVWF FC_CAL_UAR_00062_arg_nChar
	CLRF FC_CAL_UAR_00062_arg_nChar+D'1'
	CALL FC_CAL_UAR_00062
	MOVF FCD_0f051__00080_arg_FCL_T_00081, F
	BZ	label41
	CLRF FC_CAL_UAR_00062_arg_nChar
	CLRF FC_CAL_UAR_00062_arg_nChar+D'1'
	CALL FC_CAL_UAR_00062
	BRA	label42
label41
...
label42
	...
	CLRF FC_CAL_UAR_00062_arg_nChar+D'1'
	CALL FC_CAL_UAR_00062
	MOVF FCD_0f051__00080_arg_FCL_X1+D'1', W
	MOVWF FC_CAL_UAR_00062_arg_nChar
	CLRF FC_CAL_UAR_00062_arg_nChar+D'1'
	CALL FC_CAL_UAR_00062
	MOVF FCD_0f051__00080_arg_FCL_X1, W
	MOVWF FC_CAL_UAR_00062_arg_nChar
	MOVF FCD_0f051__00080_arg_FCL_X1+D'1', W
	MOVWF FC_CAL_UAR_00062_arg_nChar+D'1'
	CALL FC_CAL_UAR_00062
	MOVF FCD_0f051__00080_arg_FCL_Y1+D'1', W
	MOVWF FC_CAL_UAR_00062_arg_nChar
	CLRF FC_CAL_UAR_00062_arg_nChar+D'1'
	CALL FC_CAL_UAR_00062
	MOVF FCD_0f051__00080_arg_FCL_Y1, W
	MOVWF FC_CAL_UAR_00062_arg_nChar
	MOVF FCD_0f051__00080_arg_FCL_Y1+D'1', W
	MOVWF FC_CAL_UAR_00062_arg_nChar+D'1'
	CALL FC_CAL_UAR_00062
	MOVF FCD_0f051__00080_arg_FCL_FONT, W
	MOVWF FC_CAL_UAR_00062_arg_nChar
	CLRF FC_CAL_UAR_00062_arg_nChar+D'1'
	CALL FC_CAL_UAR_00062
	...
	CLRF FC_CAL_UAR_00062_arg_nChar+D'1'
	CALL FC_CAL_UAR_00062
	MOVF FCD_0f051__00080_arg_FCL_STR, W
	MOVWF FCI_GETLEN_0004B_arg_sStr1
	MOVF FCD_0f051__00080_arg_FCL_STR+D'1', W
	MOVWF FCI_GETLEN_0004B_arg_sStr1+D'1'
	MOVF FCD_0f051__00080_arg_FCLsz_STR, W
	MOVWF FCI_GETLEN_0004B_arg_iStr1_len
	CALL FCI_GETLEN_0004B
	MOVF CompTempVarRet1850, W
	MOVWF FCD_0f051__00080_1_FCL_LEN_STR
label43
	MOVF FCD_0f051__00080_1_FCL_LEN_STR, W
	CPFSLT FCD_0f051__00080_1_FCL_IDX
	BRA	label44
	MOVF FCD_0f051__00080_arg_FCL_STR+D'1', W
	MOVWF FSR0H
	MOVF FCD_0f051__00080_arg_FCL_STR, W
	ADDWF FCD_0f051__00080_1_FCL_IDX, W
	MOVWF FSR0L
	MOVF INDF0, F
	BZ	label44
	MOVF FCD_0f051__00080_arg_FCL_STR+D'1', W
	...
	CLRF FC_CAL_UAR_00062_arg_nChar+D'1'
	CALL FC_CAL_UAR_00062
	INCF FCD_0f051__00080_1_FCL_IDX, W
	MOVWF FCD_0f051__00080_1_FCL_IDX
	BRA	label43
label44
	CLRF FC_CAL_UAR_00062_arg_nChar
	CLRF FC_CAL_UAR_00062_arg_nChar+D'1'
...
; { FCD_0f051_gLCD_EB076_4D1__PrintNumber ; function begin
	MOVF FCD_0f051__0007E_arg_FCL_NUMBER, W
	MOVWF FCI_TOSTRI_0004F_arg_iSrc1
	MOVF FCD_0f051__0007E_arg_FCL_NUMBER+D'1', W
	MOVWF FCI_TOSTRI_0004F_arg_iSrc1+D'1'
	CLRF FCI_TOSTRI_0004F_arg_iSrc1+D'2'
	CLRF FCI_TOSTRI_0004F_arg_iSrc1+D'3'
	BTFSS FCD_0f051__0007E_arg_FCL_NUMBER+D'1',7
	BRA	label47
	DECF FCI_TOSTRI_0004F_arg_iSrc1+D'2', F
	DECF FCI_TOSTRI_0004F_arg_iSrc1+D'3', F
label47
	MOVLW HIGH(FCD_0f051__0007E_1_FCL_TEMP+D'0')
	MOVWF FCI_TOSTRI_0004F_arg_sDst+D'1'
	MOVLW LOW(FCD_0f051__0007E_1_FCL_TEMP+D'0')
	MOVWF FCI_TOSTRI_0004F_arg_sDst
	MOVLW 0x06
	MOVWF FCI_TOSTRI_0004F_arg_iDst_len
	CALL FCI_TOSTRI_0004F
	MOVLW HIGH(FCD_0f051__0007E_1_FCL_TEMP+D'0')
	MOVWF FCD_0f051__00080_arg_FCL_STR+D'1'
	MOVLW LOW(FCD_0f051__0007E_1_FCL_TEMP+D'0')
	MOVWF FCD_0f051__00080_arg_FCL_STR
	MOVLW 0x06
	MOVWF FCD_0f051__00080_arg_FCLsz_STR
	CLRF FCD_0f051__00080_arg_FCLsz_STR+D'1'
	MOVF FCD_0f051__0007E_arg_FCL_X, W
	MOVWF FCD_0f051__00080_arg_FCL_X1
	MOVF FCD_0f051__0007E_arg_FCL_X+D'1', W
	MOVWF FCD_0f051__00080_arg_FCL_X1+D'1'
	MOVF FCD_0f051__0007E_arg_FCL_Y, W
	MOVWF FCD_0f051__00080_arg_FCL_Y1
	MOVF FCD_0f051__0007E_arg_FCL_Y+D'1', W
	MOVWF FCD_0f051__00080_arg_FCL_Y1+D'1'
	MOVF FCD_0f051__0007E_arg_FCL_FONT, W
	MOVWF FCD_0f051__00080_arg_FCL_FONT
	MOVF FCD_0f051__0007E_arg_FCL_T_0007F, W
	MOVWF FCD_0f051__00080_arg_FCL_T_00081
...
label48
	...
	CALL FCD_0f051__00093
	MOVF gbl_FCV_A, W
	MOVWF FCD_0f051__0007E_arg_FCL_NUMBER
	CLRF FCD_0f051__0007E_arg_FCL_NUMBER+D'1'
	MOVLW 0x96
	MOVWF FCD_0f051__0007E_arg_FCL_X
	CLRF FCD_0f051__0007E_arg_FCL_X+D'1'
	MOVLW 0xC8
	MOVWF FCD_0f051__0007E_arg_FCL_Y
	CLRF FCD_0f051__0007E_arg_FCL_Y+D'1'
	CLRF FCD_0f051__0007E_arg_FCL_FONT
	MOVLW 0x02
	MOVWF FCD_0f051__0007E_arg_FCL_T_0007F
