//************************************************************************************
//**  
//**  Source name:   U:\Documents\SIN\BatailleNavale\Test_Mise_En_Commun.fcfx
//**  Title:         
//**  Description:   
//**  Device:        PIC.18F.18F4520
//**  
//**  Generated by:  Flowcode v6.1.1.0
//**  Date:          Monday, April 03, 2017 13:57:17
//**  Users:         50
...
\*========================================================================*/
#define FCVsz_TABLEAUJ2 101
#define FCVsz_TABLEAUJ1 101
#define FCV_FALSE (0)
#define FCV_TRUE (1)
MX_GLOBAL MX_UINT8 FCV_HITBOX_JOUEUR_2 = (0x1);
...
MX_GLOBAL MX_CHAR FCV_TABLEAUJ2[FCVsz_TABLEAUJ2];
MX_GLOBAL MX_UINT8 FCV_NUM_CASE = (0x0);
MX_GLOBAL MX_CHAR FCV_TABLEAUJ1[FCVsz_TABLEAUJ1];
...
MX_GLOBAL MX_UINT16 FCV_POSI_X2 = (0x18);
MX_GLOBAL MX_UINT16 FCV_POSI_X1 = (0x0);
MX_GLOBAL MX_UINT8 FCV_TOUR = (0x1);
MX_GLOBAL MX_UINT16 FCV_POSI_Y2 = (0x18);
MX_GLOBAL MX_UINT8 FCV_APPUI_ECRAN = (0x0);
MX_GLOBAL MX_UINT16 FCV_POSI_Y1 = (0x0);
MX_GLOBAL MX_UINT8 FCV_HITBOX_2 = (0x0);
MX_GLOBAL MX_UINT16 FCV_HITBOX_1 = (0x1);
...
void FCM_Choix_affichage_bateauxJ2();
void FCM_Reinitialisation_tactile();
void FCM_Choix_Bateau_Toucher();
void FCM_Choix_affichage_bateauxJ1();
void FCM_phase_Fin();
void FCM_Choix_Bateaux();
void FCM_affichage_bateau();
void FCM_Affichage_Avec_bateau();
void FCM_Sous_marin();
void FCM_Affichage_Sans_bateau();
...
void FCM_Toucher_CoulerJ2();
void FCM_hitbox_phase_jeu();
void FCM_Toucher_CoulerJ1();
...
void FCM_Touche_Coule_TORP()
{
	...
	// Calcul
	// Calcul:
	//  tableauJ1[hitbox_Joueur_1] = (tableauJ1[hitbox_Joueur_1] OR 128)
	//  Torpilleur = Torpilleur - 1
	FCV_TABLEAUJ1[FCV_HITBOX_JOUEUR_1] = (FCV_TABLEAUJ1[FCV_HITBOX_JOUEUR_1] | 128);
...
void FCM_Croiseur()
{
	...
	// Calcul
	// Calcul:
	//  tableauJ1[hitbox_Joueur_1] = 0b00000010
	//  bateau = bateau + 1
	//  X_SORTIE = 0
	//  Appui_Ecran = 0
	//  X = 0
	//  Y = 0
	//  Croiseur = Croiseur + 1
	FCV_TABLEAUJ1[FCV_HITBOX_JOUEUR_1] = 2;
...
void FCM_Torpilleur()
{
	...
	// Calcul
	// Calcul:
	//  tableauJ1[hitbox_Joueur_1] = 0b00000101
	//  bateau = bateau + 1
	//  X_SORTIE = 0
	//  Appui_Ecran = 0
	//  X = 0
	//  Y = 0
	//  Torpilleur = Torpilleur + 1
	FCV_TABLEAUJ1[FCV_HITBOX_JOUEUR_1] = 5;
	FCV_BATEAU = FCV_BATEAU + 1;
	FCV_X_SORTIE = 0;
	FCV_APPUI_ECRAN = 0;
	FCV_X = 0;
...
void FCM_Initialisation()
{
	...
	while (1)
	{
		...
		// Calcul
		// Calcul:
		//  tableauJ1[hitbox_Joueur_1] = 0b00000000
		//  hitbox_Joueur_1 = hitbox_Joueur_1 + 1
		FCV_TABLEAUJ1[FCV_HITBOX_JOUEUR_1] = 0;
	...
	// Boucle
	// Boucle: While hitbox_Joueur_2 = 101
	while (1)
	{

		// Calcul
		// Calcul:
		//  tableauJ2[hitbox_Joueur_2] = 0b00000000
		//  hitbox_Joueur_2 = hitbox_Joueur_2 + 1
		FCV_TABLEAUJ2[FCV_HITBOX_JOUEUR_2] = 0;
		FCV_HITBOX_JOUEUR_2 = FCV_HITBOX_JOUEUR_2 + 1;


		if ((FCV_HITBOX_JOUEUR_2 == 101) != 0) break;
	}

	#if 0 // Disabled code
	// Calcul
	// Calcul:
	//  tableauJ1[23] = 0b00000001
	//  tableauJ1[24] = 0b00000001
	//  tableauJ1[25] = 0b00000001
	FCV_TABLEAUJ1[23] = 1;
	FCV_TABLEAUJ1[24] = 1;
	FCV_TABLEAUJ1[25] = 1;
...
void FCM_Choix_affichage_bateauxJ2()
{
	...
	// Boucle
	// Boucle: While hitbox_Joueur_2 = 100
	while (1)
	{

		// Décision
		// Décision: (tableauJ2[hitbox_Joueur_2] & (0b00000111)) = 0?
		if ((FCV_TABLEAUJ2[FCV_HITBOX_JOUEUR_2] & (7)) == 0)
		{

		} else {

			// Appel d'une Macro
			// Appel d'une Macro: Affichage_Avec_bateau()
			FCM_Affichage_Avec_bateau();
		...
		if ((FCV_HITBOX_JOUEUR_2 == 100) != 0) break;
	}
...
void FCM_Choix_affichage_bateauxJ1()
{
	...
	while (1)
	{
		...
		// Décision
		// Décision: (tableauJ1[hitbox_Joueur_1] & (0b10000000)) = 0?
		if ((FCV_TABLEAUJ1[FCV_HITBOX_JOUEUR_1] & (128)) == 0)
		{
...
void FCM_Affichage_Avec_bateau()
{
	...
	// Boucle
	// Boucle: While hitbox_1 < hitbox_Joueur_1
	while (FCV_HITBOX_1 < FCV_HITBOX_JOUEUR_1)
	{

		// Décision
		// Décision: posi_x2 < 240?
		if (FCV_POSI_X2 < 240)
		{
			...
			//  posi_x2 = posi_x2 + 24
			//  hitbox_1 = hitbox_1 + 1
			FCV_POSI_X1 = FCV_POSI_X1 + 24;
			FCV_POSI_X2 = FCV_POSI_X2 + 24;
			FCV_HITBOX_1 = FCV_HITBOX_1 + 1;
			...
			FCV_POSI_X1 = 0;
			FCV_POSI_X2 = 24;
			FCV_POSI_Y1 = FCV_POSI_Y1 + 24;
			FCV_POSI_Y2 = FCV_POSI_Y2 + 24;
	...
	// Appel d'une Macro
	// Appel d'une Macro: parametres_bateau(posi_x1, posi_x2, posi_y1, posi_y2, 255, 0, 0)
	FCM_parametres_bateau(FCV_POSI_X1, FCV_POSI_X2, FCV_POSI_Y1, FCV_POSI_Y2, 255, 0, 0);
...
void FCM_Sous_marin()
{
	...
	// Calcul
	// Calcul:
	//  tableauJ1[hitbox_Joueur_1] = 0b00000100
	//  bateau = bateau + 1
	//  X_SORTIE = 0
	//  Appui_Ecran = 0
	//  X = 0
	//  Y = 0
	//  Sous_marin = Sous_marin + 1
	FCV_TABLEAUJ1[FCV_HITBOX_JOUEUR_1] = 4;
	FCV_BATEAU = FCV_BATEAU + 1;
	FCV_X_SORTIE = 0;
	FCV_APPUI_ECRAN = 0;
	FCV_X = 0;
...
void FCM_Toucher_CoulerJ2()
{
	...
	while (FCV_X_SORTIE < 1)
	{
		...
		if (FCV_Y_TOUCH < FCV_Y)
		{
			...
			// Calcul
			// Calcul:
			//  hitbox_Joueur_2 = hitbox_Joueur_2 + 10
			//  Y = Y + 24
			FCV_HITBOX_JOUEUR_2 = FCV_HITBOX_JOUEUR_2 + 10;
			FCV_Y = FCV_Y + 24;
	...
	// Porte-avion
	// Décision: tableauJ2[hitbox_Joueur_2] = 0b00000001?
	if (FCV_TABLEAUJ2[FCV_HITBOX_JOUEUR_2] == 1)
	{
		...
		// Croiseur
		// Décision: tableauJ2[hitbox_Joueur_2] = 0b00000010?
		if (FCV_TABLEAUJ2[FCV_HITBOX_JOUEUR_2] == 2)
		{
			...
			// Décision
			// Décision: tableauJ2[hitbox_Joueur_2] = 0b00000011?
			if (FCV_TABLEAUJ2[FCV_HITBOX_JOUEUR_2] == 3)
			{
				...
				// Décision
				// Décision: tableauJ2[hitbox_Joueur_2] = 0b00000100?
				if (FCV_TABLEAUJ2[FCV_HITBOX_JOUEUR_2] == 4)
				{
					...
					// Décision
					// Décision: tableauJ2[hitbox_Joueur_2] = 0b00000101?
					if (FCV_TABLEAUJ2[FCV_HITBOX_JOUEUR_2] == 5)
					{
...
void FCM_Toucher_CoulerJ1()
{
	...
	// Porte-avion
	// Décision: tableauJ1[hitbox_Joueur_1] = 0b00000001?
	if (FCV_TABLEAUJ1[FCV_HITBOX_JOUEUR_1] == 1)
	{
		...
		// Croiseur
		// Décision: tableauJ1[hitbox_Joueur_1] = 0b00000010?
		if (FCV_TABLEAUJ1[FCV_HITBOX_JOUEUR_1] == 2)
		{
			...
			// Décision
			// Décision: tableauJ1[hitbox_Joueur_1] = 0b00000011?
			if (FCV_TABLEAUJ1[FCV_HITBOX_JOUEUR_1] == 3)
			{
				...
				// Décision
				// Décision: tableauJ1[hitbox_Joueur_1] = 0b00000100?
				if (FCV_TABLEAUJ1[FCV_HITBOX_JOUEUR_1] == 4)
				{
					...
					// Décision
					// Décision: tableauJ1[hitbox_Joueur_1] = 0b00000101?
					if (FCV_TABLEAUJ1[FCV_HITBOX_JOUEUR_1] == 5)
					{
...
void FCM_Porte_avion()
{
	...
	// Calcul
	// Calcul:
	//  tableauJ1[hitbox_Joueur_1] = 0b00000001
	//  bateau = bateau + 1
	//  X_SORTIE = 0
	//  Appui_Ecran = 0
	//  X = 0
	//  Y = 0
	//  Porte_avion = Porte_avion + 1
	FCV_TABLEAUJ1[FCV_HITBOX_JOUEUR_1] = 1;
	FCV_BATEAU = FCV_BATEAU + 1;
	FCV_X_SORTIE = 0;
	FCV_APPUI_ECRAN = 0;
	FCV_X = 0;
...
void FCM_Touche_coule_CR()
{
	...
	// Calcul:
	//  tableauJ1[hitbox_Joueur_1] = (tableauJ1[hitbox_Joueur_1] OR 128)
	//  Croiseur = Croiseur - 10000
	FCV_TABLEAUJ1[FCV_HITBOX_JOUEUR_1] = (FCV_TABLEAUJ1[FCV_HITBOX_JOUEUR_1] | 128);
	FCV_CROISEUR = FCV_CROISEUR - 10000;
...
void FCM_Phase_jeu()
{
	...
	while (1)
	{
		...
		// Appel d'une Macro
		// Appel d'une Macro: Choix_affichage_bateauxJ1()
		FCM_Choix_affichage_bateauxJ1();
		...
		// Appel d'une Macro
		// Appel d'une Macro: Toucher_CoulerJ1()
		FCM_Toucher_CoulerJ1();
		...
		if (FCV_TOUR == 1)
		{
			...
			#if 0 // Disabled code
			// Appel d'une Macro
			// Appel d'une Macro: Choix_affichage_bateauxJ2()
			FCM_Choix_affichage_bateauxJ2();
			...
			#if 0 // Disabled code
			// Appel d'une Macro
			// Appel d'une Macro: Toucher_CoulerJ2()
			FCM_Toucher_CoulerJ2();
...
void FCM_Contre_torpilleur()
{
	...
	// Calcul
	// Calcul:
	//  tableauJ1[hitbox_Joueur_1] = 0b00000011
	//  bateau = bateau + 1
	//  X_SORTIE = 0
	//  Appui_Ecran = 0
	//  X = 0
	//  Y = 0
	//  Contre_torpilleur = Contre_torpilleur + 1
	FCV_TABLEAUJ1[FCV_HITBOX_JOUEUR_1] = 3;
	FCV_BATEAU = FCV_BATEAU + 1;
	FCV_X_SORTIE = 0;
	FCV_APPUI_ECRAN = 0;
	FCV_X = 0;
