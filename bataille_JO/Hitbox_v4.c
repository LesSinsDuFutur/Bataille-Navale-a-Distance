//************************************************************************************
//**  
//**  Source name:   U:\Documents\SIN\BatailleNavale\Hitbox_v4.fcfx
//**  Title:         
//**  Description:   
//**  Device:        PIC.18F.18F4520
//**  
//**  Generated by:  Flowcode v6.1.1.0
//**  Date:          Tuesday, January 24, 2017 15:41:16
//**  Users:         50
...
void FCM_X_48();
void FCM_parametres_bateau(MX_UINT16 FCL_POS_X1, MX_UINT16 FCL_POS_X2, MX_UINT16 FCL_POS_Y1, MX_UINT16 FCL_POS_Y2, MX_UINT8 FCL_COULEUR_ROUGE, MX_UINT8 FCL_COULEUR_BLEU, MX_UINT8 FCL_COULEUR_VERT);
...
void FCM_affichage_bateau()
{
	...
	while (1)
	{
		...
		if (FCV_HITBOX == 68)
		{
			...
			// Appel de la Routine Composant
			// Appel d'une Macro: parametres_bateau(168, 192, 144, 168, 50, 50, 50)
			FCM_parametres_bateau(168, 192, 144, 168, 50, 50, 50);
